...
class CrmTest extends \Tester\TestCase
{
    ...
    /** @var \ondrs\Vehico\Api\PrivateApi\Crm\Crm */
    private $crmApi;
    ...
    function setUp()
    {
        ...
        $this->crmApi = new \ondrs\Vehico\Api\PrivateApi\Crm\CrmApi(TEMP_DIR, $apiKey, 'https://localhost/vehico/vehico-server/www/api');
        */
        ...
        $this->crmApi = new \ondrs\Vehico\Api\PrivateApi\Crm\Crm(TEMP_DIR, $apiKey, 'https://test.vehico.cz/api');
    ...
    {
        $customer = new \ondrs\Vehico\Api\PrivateApi\Crm\Entity\CustomerEntity;
        $customer->name = 'Pepa';
        $customer->surname = 'Tester';
        $customer->email = 'pepa@tester.cz';
        $customer->telephone = 798456123;
        $customer->countries_id = 'CZ';
        $customer->type = \ondrs\Vehico\Api\PrivateApi\Crm\Entity\CustomerEntity::TYPE_INDIVIDUAL;

        $case = new \ondrs\Vehico\Api\PrivateApi\Crm\Entity\CaseEntity;
